...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create new Notifications</h1>
    </div>

    <div class="col-lg-8">
        <form method="post" action="/dashboard/notifications/create" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary">Create Notifications</button>
        </form>
    </div>
@endsection
